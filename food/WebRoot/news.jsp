...
<%@page import="com.serviceImpl.NewsServiceImpl"%>
<%@page import="com.services.NewsService"%>
        ...
        <div id="main">
            ...
            <div id="container">
                ...
                <%
	            	...
	            	int totalPage = newsService.getTotalCount();
                  ...
                  %>
                    <tr>
                        <td class="title">
                            <a href="newsDetails.jsp?id=<%=news.getId()%>"><%=news.getTitle() %></a>
                        </td>
                ...
                <div class="pager">
                <a href="news.jsp?pageIndex=<%=pageIndex-1%>">上一页</a>
                &nbsp;&nbsp;
                <a href="news.jsp?pageIndex=<%=pageIndex+1%>">下一页</a></div>
            </div>
            <div class="clear"></div>
        </div>
        <div id="footer">
